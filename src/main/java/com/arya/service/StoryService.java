...
public class StoryService {
	...
	public ResponseEntity<Story> getStoryById(Long storyId)
	...
	public ResponseEntity<List<Story>> getStoryByName(String storyName)
				throws ResourceNotFoundException {
	...
	public ResponseEntity<List<Story>> getStoryBySummary(String storySummary)
				throws ResourceNotFoundException {
	 ...
	 public ResponseEntity<List<Story>> getStoryByDescription(String storyDescription)
			  throws ResourceNotFoundException {
	  ...
	  public ResponseEntity<List<Story>> getStoryByOwner(String storyOwner)
			  throws ResourceNotFoundException {
	  ...
	  public ResponseEntity<List<Story>> getStoryByPriority(String storyPriority)
			  throws ResourceNotFoundException {
	  ...
	  public ResponseEntity<List<Story>> getStoryByAssigned(String storyAssigned)
			  throws ResourceNotFoundException {
	  ...
	  public ResponseEntity<Story> updateStory( Long storyId,
		...
		public Map<String, Boolean> deleteStory(Long storyId)
				throws ResourceNotFoundException {
