...
public class StoryControllerTest {
	...
	public void insertStoryTest() {
		Story story = new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg");
	...
	public void getAllStoryTest() {
		when(storyRepository.findAll()).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryByNameTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findByName(storyName)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryBySummaryTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findBySummary(storySummary)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryByDescriptionTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findByDescription(storyDescription)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryByOwnerTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findByOwner(storyOwner)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryByPriorityTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findByPriority(storyPriority)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
	...
	public void getStoryByAssignedTest() throws ResourceNotFoundException {
		...
		when(storyRepository.findByAssigned(storyAssigned)).thenReturn(Stream.of(new Story(1L,"Hridoy","fhghg","cdcgf","kjhj","hgf","ghg")).collect(Collectors.toList()));
